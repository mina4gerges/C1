...
public final class MenuCatalog {
    ...
    private static void createProduct() {
        ...
        try {
            final Category category = _cdao.find(line.nextToken().trim());
    ...
    private static void createItem() {
        ...
        try {
            final Product product = _pdao.find(line.nextToken().trim());
    ...
    private static void findItem() {
        ...
        try {
            // Calls the method that retreives all the data of the object
            final Item item = _idao.find(line.nextToken().trim());
            System.out.println("\n" + item);
            System.out.println("\n\tPress enter to continue...");
        } catch (ObjectNotFoundException e) {
